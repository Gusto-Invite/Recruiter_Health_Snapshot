...
async function init() {
  ...
  fetchSheetRows('Pipeline Snapshot [PLEASE DO NOT TOUCH]').then(pipeText => {
    ...
    // Log first 3 rows of the TSV so we can see the header row format
